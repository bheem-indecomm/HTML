                ...
                wrapInput: function (a) {
                    for (var b = 0; b < a.length; b++) {
                        ...
                        if ("input" === c.tagName.toLowerCase()) {
                            ...
                            if ("file" === c.type.toLowerCase()) {
                                var e = document.createElement("span");
                                e.className = c.className + " upLogoBtn";
                            }
                            else if ("submit" === c.type.toLowerCase() || "button" === c.type.toLowerCase()) {
                                var e = document.createElement("span");
                    ...
                    d.before(q), q.before(o), q.after(i), d.is(":disabled") || q.dropdown({
                        ...
                        focus: function () {
                            if (a("ul.select-dropdown").not(i[0]).is(":visible") && a("input.select-dropdown").trigger("close"), !i.is(":visible")) {
                                ...
                                activateOption(i, c);
                                //a("ul.select-dropdown").css('top', '46px');
                            }
                        },
                        click: function (a) {
                            a.stopPropagation()
